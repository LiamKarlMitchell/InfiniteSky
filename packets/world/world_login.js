...
// console.log("World buffer size: " + worldBuffer.length);

// WorldPC.onLoginWorldPacket = restruct.
// int8lu('PacketID').
// int8lu('unk').
// int8lu('unk').
// int8lu('unk').
...
var WorldCharacterInfoPacket = restruct.
	int8lu('PacketID').
	int8lu('Status').
