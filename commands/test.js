...
GMCommands.AddCommand(new Command('bling', 80, function(string, client) {
	...
	client.character.state._oUnknown99 = 0;
	...
	client.character.state._oUnknown120 =0;
	client.character.state._oUnknown121 =0;
	client.character.state._oUnknown122 =0;
	client.character.state._oUnknown123 =0;
	client.character.state._oUnknown124 =0;
	client.character.state._oUnknown125 =0;
	client.character.state._oUnknown126 =0;
	client.character.state._oUnknown127 =0;
	client.character.state._oUnknown128 =0;
	client.character.state._oUnknown129 =0;
	client.character.state._oUnknown130 =0;
	client.character.state._oUnknown131 =0;
	client.character.state._oUnknown132 =0;
	client.character.state._oUnknown133 =0;
	client.character.state._oUnknown134 =0;
	client.character.state._oUnknown135 =0;
	client.character.state._oUnknown136 =0;
	client.character.state._oUnknown137 =0;//def buff its 1x30min ( not stackeble)
	client.character.state._oUnknown138 =0;//blue pvp buff
	client.character.state._oUnknown139 =0;
	client.character.state._oUnknown140 =0;
	client.character.state._oUnknown141 =0;
	client.character.state._oUnknown142 =0;
	client.character.state._oUnknown143 =0;// pet buff
	client.character.state._oUnknown144 =0;
